...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::agent::scan_grok_sessions,
            ...
            commands::agent::build_grok_launch_command,
            ...
            commands::agent::prepare_grok_launch,
            ...
            commands::todo::list_todo_snapshots,
            commands::todo::save_todo_snapshot,
